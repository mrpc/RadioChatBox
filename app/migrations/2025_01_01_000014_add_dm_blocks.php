...
/**
 * Baselined from database/migrations/017_add_dm_blocks.sql.
 *
 ...
 */
final class AddDmBlocks extends Migration
{
    public $description = 'Baselined: 017_add_dm_blocks.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/017_add_dm_blocks.sql');
        if (trim($sql) !== '') {
