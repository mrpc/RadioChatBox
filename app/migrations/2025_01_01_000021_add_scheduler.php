...
/**
 * Baselined from database/migrations/024_add_scheduler.sql.
 *
 ...
 */
final class AddScheduler extends Migration
{
    public $description = 'Baselined: 024_add_scheduler.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/024_add_scheduler.sql');
        if (trim($sql) !== '') {
