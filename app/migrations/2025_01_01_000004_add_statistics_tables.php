...
/**
 * Baselined from database/migrations/006_add_statistics_tables.sql.
 *
 ...
 */
final class AddStatisticsTables extends Migration
{
    public $description = 'Baselined: 006_add_statistics_tables.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/006_add_statistics_tables.sql');
        if (trim($sql) !== '') {
