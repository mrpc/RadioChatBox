...
/**
 * Baselined from database/migrations/018_add_message_reactions.sql.
 *
 ...
 */
final class AddMessageReactions extends Migration
{
    public $description = 'Baselined: 018_add_message_reactions.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/018_add_message_reactions.sql');
        if (trim($sql) !== '') {
