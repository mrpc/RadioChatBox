...
/**
 * Baselined from database/migrations/016_add_edited_at_to_messages.sql.
 *
...
{
    public $description = 'Baselined: 016_add_edited_at_to_messages.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/016_add_edited_at_to_messages.sql');
        if (trim($sql) !== '') {
