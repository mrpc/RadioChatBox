...
/**
 * Baselined from database/migrations/022_backfill_artists.sql.
 *
...
{
    public $description = 'Baselined: 022_backfill_artists.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/022_backfill_artists.sql');
        if (trim($sql) !== '') {
