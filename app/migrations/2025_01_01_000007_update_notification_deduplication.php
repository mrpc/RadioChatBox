...
/**
 * Baselined from database/migrations/009_update_notification_deduplication.sql.
 *
 ...
 */
final class UpdateNotificationDeduplication extends Migration
{
    public $description = 'Baselined: 009_update_notification_deduplication.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/009_update_notification_deduplication.sql');
        if (trim($sql) !== '') {
