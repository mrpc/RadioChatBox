...
/**
 * Baselined from database/migrations/019_add_track_plays.sql.
 *
...
{
    public $description = 'Baselined: 019_add_track_plays.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/019_add_track_plays.sql');
        if (trim($sql) !== '') {
