...
/**
 * Baselined from database/migrations/007_add_admin_notifications.sql.
 *
 ...
 */
final class AddAdminNotifications extends Migration
{
    public $description = 'Baselined: 007_add_admin_notifications.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/007_add_admin_notifications.sql');
        if (trim($sql) !== '') {
