...
/**
 * Baselined from database/migrations/005_rename_tables_logical_structure.sql.
 *
 ...
 */
final class RenameTablesLogicalStructure extends Migration
{
    public $description = 'Baselined: 005_rename_tables_logical_structure.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/005_rename_tables_logical_structure.sql');
        if (trim($sql) !== '') {
