...
/**
 * Baselined from database/migrations/004_add_url_whitelist.sql.
 *
...
{
    public $description = 'Baselined: 004_add_url_whitelist.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/004_add_url_whitelist.sql');
        if (trim($sql) !== '') {
