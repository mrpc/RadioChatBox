...
/**
 * Baselined from database/migrations/023_add_bot_replies.sql.
 *
...
{
    public $description = 'Baselined: 023_add_bot_replies.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/023_add_bot_replies.sql');
        if (trim($sql) !== '') {
