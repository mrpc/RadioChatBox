...
/**
 * Baselined from database/migrations/008_add_radio_peak_to_hourly_stats.sql.
 *
 ...
 */
final class AddRadioPeakToHourlyStats extends Migration
{
    public $description = 'Baselined: 008_add_radio_peak_to_hourly_stats.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/008_add_radio_peak_to_hourly_stats.sql');
        if (trim($sql) !== '') {
