...
/**
 * Baselined from database/migrations/021_add_track_metadata.sql.
 *
 ...
 */
final class AddTrackMetadata extends Migration
{
    public $description = 'Baselined: 021_add_track_metadata.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/021_add_track_metadata.sql');
        if (trim($sql) !== '') {
