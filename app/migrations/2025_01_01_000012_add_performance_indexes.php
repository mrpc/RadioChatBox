...
/**
 * Baselined from database/migrations/015_add_performance_indexes.sql.
 *
 ...
 */
final class AddPerformanceIndexes extends Migration
{
    public $description = 'Baselined: 015_add_performance_indexes.sql';
    ...
    public function up(): void
    {
        ...
        $sql = (string) file_get_contents($root . '/database/migrations/015_add_performance_indexes.sql');
        if (trim($sql) !== '') {
