...
try {
    ...
    // Get the authenticated username from the Authorization header
    // Extract from "Bearer username:password" format
    ...
    // Value stores username and expiry timestamp for validation
