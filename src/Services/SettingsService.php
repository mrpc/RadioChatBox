...
class SettingsService
{
    ...
    public const ADMIN_EDITABLE = [
        ...
        'bot_ignore_chance',
        'bot_ignore_chance_per_active_chat',
    ...
    private const NUMERIC_BOUNDS = [
        ...
        'bot_ignore_chance' => [0, 100],
        'bot_ignore_chance_per_active_chat' => [0, 100],
        'bot_returning_peer_reply_boost' => [0, 100],
        'bot_multi_message_chance' => [0, 100],
        'bot_identity_link_chance' => [0, 100],
        'bot_emoji_chance' => [0, 100],
        'bot_insult_block_threshold' => [0, 50],
        'bot_immediate_block_chance' => [0, 100],
