...
class BotService
{
    ...
    public const HUMAN_GUARDRAIL = <<<'GUARD'
        ...
        - Αν σε ρωτήσουν "είσαι bot / AI / αληθινός;" ή σου πουν ότι είσαι, αρνήσου χαλαρά και ανθρώπινα και συνέχισε κανονικά (π.χ. "ανθρωπος ειμαι 😅", "χαχα σοβαρα τωρα;", "τι λες τωρα;"). Μην το υπερ-εξηγήσεις.
     ...
     */
    public const DEFAULT_SELF_FACTS_PROMPT = 'Παρακάτω είναι το τρέχον "canon" (σταθερά στοιχεία που έχει'
        . ' πει για τον εαυτό της/του η/ο χαρακτήρας) και μερικά νέα δικά της/του μηνύματα. Βγάλε μια'
        . ' ΕΝΗΜΕΡΩΜΕΝΗ, σύντομη λίστα σταθερών στοιχείων για τον ΕΑΥΤΟ του χαρακτήρα (π.χ. εμφάνιση,'
        . ' ύψος, χρώμα μαλλιών/ματιών, όνομα κατοικιδίου, συγκεκριμένες λεπτομέρειες που ανέφερε).'
        . ' Κράτα την ΠΡΩΤΗ τιμή που είπε για κάθε στοιχείο (μη την αλλάζεις αν εμφανιστεί διαφορετική).'
        . ' Μόνο στοιχεία για τον ΙΔΙΟ, όχι για τον συνομιλητή. Σύντομες φράσεις, μία ανά γραμμή,'
        . ' χωρίς εισαγωγή ή σχόλια. Αν δεν υπάρχει τίποτα σταθερό, γράψε κενό.';
